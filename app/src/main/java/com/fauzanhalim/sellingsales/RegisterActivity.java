...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void InsertDataIntoSQLiteDatabase(){
        ...
        // This block will execute if any of the registration EditText is empty.
            ...
            Toast.makeText(RegisterActivity.this,"Mohon diisi sesuai dengan permintaan", Toast.LENGTH_LONG).show();
    ...
    public void CheckFinalResult(){
        ...
        if(F_Result.equalsIgnoreCase("Email ditemukan"))
        {
            ...
            Toast.makeText(RegisterActivity.this,"Email telah terdaftar, Mohon gunakan email lain",Toast.LENGTH_LONG).show();
